...
def masked_image(mask_type: str, imagepath: str, output_path: str = None, 
                 width: int = 576, height: int = 768, device_index: int = 0) -> str:
    """
    ...
    # Resize image
    person_r = resize_panel(person_img, width, height)
    ...
    try:
        ...
        # Create rectangle mask from body parts
        ...
        # Build control_image (masked person)
        ...
        print("Returning resized original image without masking.")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--width", type=int, default=576, help="Image width (default: 576)")
